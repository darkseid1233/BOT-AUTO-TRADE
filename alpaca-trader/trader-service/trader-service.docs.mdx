---
labels: ['trader-service', 'express', 'server', 'microservice']
description: 'trader service'
---

A trader-service component. Provides a RESTful API for the platform.
...
```bash
bit use trader-service
```

Run the server:
```bash
bit run trader-service
```
